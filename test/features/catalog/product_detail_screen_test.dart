...
import 'package:farmayopin/features/catalog/presentation/screens/product_detail_screen.dart';
...
void main() {
  ...
  group('ProductDetailScreen Widget Tests', () {
    testWidgets('Renderiza correctamente todos los datos del producto con stock', (WidgetTester tester) async {
      ...
      expect(find.text('Potente antioxidante que ayuda a fortalecer el sistema inmunologico.'), findsOneWidget);
      expect(find.text('Editar producto'), findsOneWidget);
      expect(find.text('Ver historial de compras'), findsOneWidget);
    });

    testWidgets('Renderiza estado agotado si stock es 0', (WidgetTester tester) async {
    ...
    testWidgets('Dispara callbacks al presionar botones de accion', (WidgetTester tester) async {
