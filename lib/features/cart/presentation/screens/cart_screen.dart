...
class _CartScreenState extends State<CartScreen> {
  ...
  Future<void> _goToConfirm() async {
    ...
    final paid = await Navigator.of(context).push<bool>(
      MaterialPageRoute(
        builder: (_) => ConfirmPurchaseScreen(cart: _cart, token: widget.token),
      ),
    );
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Column(
          ...
          children: [
            if (!_isLoading && _errorMessage == null && !_cart.isEmpty)
              _buildCheckoutBar(),
            _buildBottomNav(),
          ],
        ),
                  ...
                  children: [
                    Stack(
                      ...
                      children: [
                        ...
                        if (isCart && _cart.cantidadUnidades > 0)
                          Positioned(
                            right: -8,
                            top: -6,
                            child: Container(
  ...
  Widget _buildHeader() {
    return Container(
      ...
      child: Row(
        children: [
          GestureDetector(
            onTap: () => Navigator.of(context).pop(_cart),
            child: Container(
              width: 40,
              height: 40,
          ...
          if (!_cart.isEmpty)
            Text(
              '${_cart.cantidadUnidades} ${_cart.cantidadUnidades == 1 ? 'ítem' : 'ítems'}',
              style: const TextStyle(
      ...
      child: Row(
        ...
        children: [
          _stepperButton(
            ...
            onTap: isBusy
                ? null
                : () => _updateQuantity(item, item.cantidad - 1),
          ),
          Container(
